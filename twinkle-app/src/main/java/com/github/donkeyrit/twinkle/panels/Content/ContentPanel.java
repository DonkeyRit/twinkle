...
{ 
	...
	public ContentPanel(JPanel panel, CarRepository carRepository, DataBase database, String condition, int ... args)
	{
		setLayout(null); 
		...
		reload.addActionListener(new ActionListener(){ 
			...
			public void actionPerformed(ActionEvent e) {
				...
				panel.remove(temp); 
				JPanel content = new ContentPanel(panel, carRepository, database, ""); 
